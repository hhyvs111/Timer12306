...
<div style="position:absolute;top: 240px;width: 98.3%;height:73%">
		...
		<div style="width:650px;height:550px;background: #FFFFFF; border:1px solid #4682B4;position: absolute; margin-left:650px;    
	margin-top: -460px;
	...
	<span >个人信息</span>
		...
		<div style="margin:center;position:absolute; margin-left: 80px;margin-top: 100px; font-size:32px;width:50%;">			
			<span style="text-align:center;position:absolute;right:50%;font-size:22px;">*姓名：</span>
			<input type="text" name ="name" value = "${sessionScope.User.name}"class="UserName" style="position:absolute;left:50%;height: 30px;width: 250px;font-size:22px;"><br/>
			<span style="text-align:center;position:absolute;right:50%;font-size:22px;">*证件类型：</span>
			<div ><select name="idType" style="text-align:center;position:absolute;left:50%;height: 30px;width: 250px; font-size: 16px;"><option value="二代身份证">二代身份证</option><option value="护照 ">护照</option>
				<option value="港澳通行证">港澳通行证</option></select></div>
			<br/>
			<span style="text-align:center;position:absolute;right:50%;font-size:22px;">*证件号码：</span>
			<input type="text"  name ="idCard" value = "${sessionScope.User.idCard}" maxlength="18" size="20" onblur="validateidCard(this);" style="position:absolute;left:50%;height: 30px;width: 250px;font-size:22px;"><br/>
			<span style="text-align:center;position:absolute;right:50%;font-size:22px;">出生日期：</span>
			<input type="text" class="UserName" name ="birthday"value = "${sessionScope.User.birthday}" style="position:absolute;left:50%;height: 30px;width: 250px;font-size:22px;"><br/>
			<span style="text-align:center;position:absolute;right:50%;font-size:22px;">*手机号码：</span>
			<input type="text" class="UserName" name ="phoneNumber" value = "${sessionScope.User.phoneNumber}" style="position:absolute;left:50%;height: 30px;width: 250px;font-size:22px;"><br/>
			<span style="text-align:center;position:absolute;right:50%;font-size:22px;">*邮箱：</span>
			<input type="text" class="UserName" name ="mail" value = "${sessionScope.User.mail}"style="position:absolute;left:50%;height: 30px;width: 250px;font-size:22px;"><br/>
		</div>
		<div style="position: absolute; margin-left:295px;margin-top:400px;font-size:20px;width:50%;color:#4682B4">
		     <input type="submit"  class="button" name="ensure" value="保存"></a>
		</div>
		</form>
