		...
		<div style="position:absolute;top: 300px;width: 40%;left: 30%;">
				      <div class="modal-content">
				         <div class="modal-body" style="font: '微软雅黑';left:32%;line-height: 200%;">
				         	<h4 class="modal-title" id="myModalLabel" style="font-size: 32px;">您的余额不足请充值！</h4>
				         </div>
				         <div class="modal-footer">
				            <button type="submit"  onclick="javascript:window.location.href='OrderTicket.jsp';" class="btn btn-primary data-dismiss="modal">确定</button>
				         </div>
				      </div>
</div>
