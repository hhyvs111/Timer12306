...
　　　　                                                     <div style="text-align:left;color:#000000;float: left;"><strong>您现在的位置：</strong><a href="主界面">用户登录</a></div>
　　                                               </div>
		        <!--登录失败面板-->
		     <div class="lge-block">
			<div class="lge-panel">
				...
				<div class="lge-panel3">
					<p>&nbsp;&nbsp;请输入正确的用户名或密码</p>
				<input type="button" value="返回" onclick="javascript:window.location.href='Login.jsp';"
