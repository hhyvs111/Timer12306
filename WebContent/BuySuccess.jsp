...
　　　　                                                     <div style="text-align:left;color:#000000;float: left;"><strong>您现在的位置：</strong><a href="主界面">购票成功</a></div>
　　                                               </div>
		        <!--修改密码失败面板-->
		     <div class="lge-block">
			<div class="lge-panel">
				...
				<div class="lge-panel3">
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;购票成功</p>
					<input type="button" value="继续购票" onclick="javascript:window.location.href='QueryRoute.jsp';"
