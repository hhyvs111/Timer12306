...
<div style="position:absolute;top: 240px;width: 98.3%;height:73%">
		...
		<div style="margin:center;position:absolute;top:0%;left:27%;font-size:32px;width:50%;">
		    <span style="text-align:center;position:absolute;top:-50px;left:50%;color:#4682B4">系统消息</span><br/>
			<span style="text-align:center;position:absolute;left:50%;color:#2B542C;font-size:22px;">${sessionScope.User.name}您好！</span><br/>
		    <span style="font-size:22px;position:absolute;left:30%;">欢迎您登录中国铁路客户服务中心网站。</span><br/>
			<span style="color:red;font-size:22px;position:absolute;left:30%;">
</span>     <br/>
		</div>
