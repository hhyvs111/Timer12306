...
<div style="position:absolute;top: 240px;width: 98.3%;height:73%">
		...
		<div style="margin:center;position:relative;top:-450px;left:26%;font-size:32px;width:60%;border: 1px solid #4682B4;height: 100%;">
			<div style="position:relative;font-size:38px;color:black;width:100%;border:1px solid gray;text-align: center;">我的车票</div>
			<!--<div style="margin:center;position:relative;top:10px;left:5%;width:90%;border: 1px solid gray;">
	         ...
	         <hr style="width:90%;border: 1px solid #4682B4;" />
	          <div style="margin:center;position:relative;top:0px;left:5%;width:90%;height:90%;border: 1px solid gray;">
	          	<div>
				    <table align="center" class="table table-bordered" style="position:relative;margin:center;width:100%;height:50px;padding:100px;margin-bottom: 20px;font-size: 14px;border: 1px solid gray">
					            <tr>
						            ...
						            <td width="140px" align="center">车次名</td>
						            <td width="80px" align="center">车号</td>
						            <td width="100px" align="center">座位号</td>
						            <td width="120px" align="center">座位类型</td>
						            <td width="230px" align="center">发车时间</td>
						            <td width="80px" align="center">价格</td>
						         <!--    <td width="100px" align="center">出发地</td>
						            <td width="100px" align="center">目的地</td> -->
						            <td width="80px" align="center">订单id</td>
				    ...
				    <table align="center" class="table table-bordered" style="position:relative;top:10px;margin:center;width:100%;padding: 100px;margin-bottom: 20px;font-size: 14px;">
			           ...
			           <c:forEach items="${requestScope.list}" var="ticket">
			           ...
			           <tr>
					            	...
					            	<td width="80px" align="center">${ticket.id}</td>
						            <td width="100px" align="center">${ticket.name}</td>
						            <td width="140px" align="center">${ticket.route}</td>
						            <td width="80px" align="center">${ticket.routeType}</td>
						            <td width="100px" align="center">${ticket.seatNum}</td>
						            <td width="120px" align="center">${ticket.seatType}</td>
						            <td width="217px" align="center">${ticket.departureTime}</td>
						            <td width="80px" align="center">${ticket.price}元</td>
						            <%-- <td width="80px" align="center">${ticket.from}</td>
						            <td width="80px" align="center">${ticket.to}</td> --%>
						            <td width="80px" align="center">${ticket.orderId}</td>
						            <td width="80px" align="center">${ticket.routeId}</td>
						           <%--  <td width="80px" align="center">${ticket.userId}</td> --%>
						            <td width="100px" align="center"><input type = "submit" value= "退票"></td>
					            </tr>
					            </form>
					            </c:forEach>	
